  ...
  return jsonWithCors({
    ...
    info: {
      ...
      description: [
        ...
        "The API streams progress through pollable run state: agent events, official trial cards, research papers, web/X patient voice, missing eligibility info, generated artifacts, and Nia-indexed chat.",
    ...
    "x-light-demo-flow": [
      ...
      "Render trials, research, patientVoice, eligibility, burden, artifacts.",
...
function schemas() {
  return {
    ...
    TrialIntelligenceState: { type: "object", properties: { runId: { type: "string" }, status: { enum: ["created", "running", "completed", "failed"] }, sourceMode: { enum: ["real", "mixed", "mock"] }, patient: { $ref: "#/components/schemas/PatientProfileInput" }, capabilities: { $ref: "#/components/schemas/CapabilityReport" }, events: { type: "array", items: { $ref: "#/components/schemas/AgentEvent" } }, trials: { type: "array", items: { $ref: "#/components/schemas/TrialCard" } }, research: { $ref: "#/components/schemas/ResearchSummary" }, patientVoice: { type: "array", items: { $ref: "#/components/schemas/PatientVoiceTheme" } }, eligibility: { type: "array", items: { $ref: "#/components/schemas/EligibilityRow" } }, artifacts: { type: "array", items: { $ref: "#/components/schemas/GeneratedArtifact" } }, createdAt: { type: "string" }, updatedAt: { type: "string" } } },
